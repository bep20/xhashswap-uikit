...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://poocoin.app/tokens/0xb30B27aDb3B0A45e88385eB2BB144Fad9120A420", target: "_blank" },
        React.createElement(Icon$X, { width: "24px", mr: "8px" }),
        React.createElement(Text, { color: "text", bold: true }, "$" + cakePriceUsd.toFixed(5)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var LangSelector = function (_a) {
    ...
    return (React.createElement(Dropdown, { position: "bottom", target: React.createElement(Button, { variant: "text", startIcon: React.createElement(Icon$1i, { color: "textSubtle", width: "24px" }) },
...
var NoProfileMenuIcon = function () { return (React.createElement(MenuIconWrapper, { borderColor: "text" },
    React.createElement(Icon$k, { color: "text", width: "24px" }))); };
