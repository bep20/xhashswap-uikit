...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#535457", backgroundDisabled: "#383939", backgroundAlt: "#151515", cardBorder: "#151515", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#161044", input: "#333333", inputSecondary: "#aaa3b9", primaryDark: "#F9F9F9", tertiary: "#757171", text: "#e2fafc", textDisabled: "#555e63", textSubtle: "#c4d4d3", disabled: "#524B63", gradients: {
        bubblegum: "#535457",
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://poocoin.app/tokens/0xb30B27aDb3B0A45e88385eB2BB144Fad9120A420", target: "_blank" },
        React__default['default'].createElement(Icon$X, { width: "24px", mr: "8px" }),
        React__default['default'].createElement(Text, { color: "text", bold: true }, "$" + cakePriceUsd.toFixed(5)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
...
var SocialLinks = function () { return (React__default['default'].createElement(Flex, null, socials.map(function (social, index) {
    ...
    var iconProps = { width: "24px", color: "text", style: { cursor: "pointer" } };
...
var LangSelector = function (_a) {
    ...
    return (React__default['default'].createElement(Dropdown, { position: "bottom", target: React__default['default'].createElement(Button, { variant: "text", startIcon: React__default['default'].createElement(Icon$1i, { color: "textSubtle", width: "24px" }) },
...
var NoProfileMenuIcon = function () { return (React__default['default'].createElement(MenuIconWrapper, { borderColor: "text" },
    React__default['default'].createElement(Icon$k, { color: "text", width: "24px" }))); };
